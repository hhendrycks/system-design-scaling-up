...
const name = ["20 oz. Hammer", "20-Volt MAX Lithium-Ion Cordless 1/2 in. Drill/Driver Kit with (2) 20-Volt Batteries 1.3Ah, Charger and Tool Bag", "French Door Refrigerator in Fingerprint Resistant Stainless Steel", "40-Volt Brushless Lithium-Ion Cordless Battery Walk Behind Push Lawn Mower", "Recycler 22 in. SmartStow Personal Pace Variable Speed High-Wheel Drive Gas Walk Behind Self Propelled Lawn Mower", "20-Volt 6-1/2 in. MAX Lithium-Ion Cordless Circular Saw (Tool-Only)", "Saw-Max 6 Amp Variable Speed Corded Tool Kit for Wood, Plastic and Metal with 2 Blades", "15 Amp Corded 12 in. Sliding Miter Saw with Laser", "M4 4-Volt Lithium-Ion Cordless 1/4 in. Hex Screwdriver 2-Battery Kit", "6 cu. ft. Wheelbarrow with Steel Handles and Flat Free Tire", "179cu. in. BBQ Hickory Wood Chips", "All-in-One Dual Mount Stainless Steel 33 in. 2-Hole Double Bowl Kitchen Sink"]
...
const rating = [5, 4, 3, 2, 5, 4.5, 3.5, 2.5];
const price = ["112.11", "5.47", "690.55", "129.00", "58.93", "264.00", "3299.00", "269.00", "2249.00", "34.92"];
const category = ['tools', 'garden', 'appliances', 'kitchen'];
